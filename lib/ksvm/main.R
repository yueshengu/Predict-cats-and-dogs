...
img_dir <- 'D:/data/ADS/Project_3/images'
...
# baseline_feature_time <- system.time(baseline_features <- feature(img_dir, img_feature_dir))
...
baseline_rate = (baseline_results[2] + baseline_results[3]) / sum(baseline_results)
